	...
	export default {
		...
		methods: {
			...
			handlehandleSendLoginSucc (res) {
				...
				sessionStorage.setItem('district', res.data.data.district)
				sessionStorage.setItem('district_name', res.data.data.district_name)
				...
				sessionStorage.setItem('school_id', res.data.data.school_id)
				sessionStorage.setItem('school_title', res.data.data.school_title)
				sessionStorage.setItem('student_id', res.data.data.student_id)
