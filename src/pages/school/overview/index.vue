<!--用户: Mr.wang     日期:2018/12/15    时间:20:09-->
<template>
    <div>
                ...
                <div class="summary">
                    ...
                    <div class="summary_item">
                        <div id="chart_know_over">
                            <el-progress class="inner_circle" color="#4B70FF" :width="140" type="circle" :percentage="overPercent" status="text" :stroke-width="15">
                                <div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goToStudentAnalysis(){
                this.$router.push({
                    path:"/school/studentAnalysis/average"
                })
            }
        }
    };
