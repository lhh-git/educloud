    ...
    <div class="eduTermList">
        ...
        <div class="container">
            <div class="termListTitle">
                <label>学年</label>
                <span v-for="(item,index) in academic_year" :class="{academic_year_active:current_academic_year == index}" @click="change_academic_year(index)">{{item}}</span>
            </div>
            <div class="termListContent">
                <div v-for="(exam,index) in examList" class="terms_list">
                    <el-col :span="24">
                        <div class="grid-content bg-purple-white el-list-edu">
                            <el-col class="exam_left" :span="18">
                                <div class="exam_title">
                                    <button :class="{border_pink:font_color == exam.subject_type}"><span :class="{pink:font_color == exam.subject_type}">{{exam.grade}}</span></button>
                                    <span class="grid-content exam_name">{{exam.examName}}</span>
                                </div>
                                <div class="exam_time">
                                    <el-col :span="24">
                                        <span>收录<span>1</span>次统考，共<span>3</span>个班级参加</span>
                                    </el-col>
                                </div>
                            </el-col>
